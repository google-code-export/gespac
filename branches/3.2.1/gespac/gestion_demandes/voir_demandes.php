...
<script type="text/javascript">	
	...
	<?PHP echo "<a href='#' onclick=\"OuvrirPage('gestion_demandes/form_demandes.php?id=-1');\"> <img src='img/add.png'>Ouvrir un dossier </a>"; ?>
		...
		<?PHP	
			...
			foreach ( $liste_des_demandes as $record ) {
				...
				echo "<tr class=$tr_class>";
					...
					echo "<td> <a href='gestion_demandes/voir_dossier.php?height=480&width=640&id=$dem_id' class='smoothbox' title='voir le dossier $dem_id'> <img src='img/loupe.gif'>$dem_id</a> </td>";					
					echo "<td> $dem_date </td>";
					...
					echo "<td> $mat_nom </td>";
					echo "<td> $dem_text </td>";
					echo "<td width=20 align=center> <a href='#' onclick=\"OuvrirPage('gestion_demandes/form_demandes.php?id=$dem_id');\" style='display:$hidemodif;'>	<img src='img/write.png' title='gérer la demande $dem_id'>	</a> </td>";
...
<?PHP
	...
	echo "<a href='#' onclick=\"OuvrirPage('gestion_demandes/form_demandes.php?id=-1');\"> <img src='img/add.png'>Ouvrir un dossier </a>";
