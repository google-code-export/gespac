...
function TB_show(caption, url, rel){
    ...
    if (!$("TB_overlay")) {
        ...
        $('TB_overlay').tween('opacity', 0, 0.5);
	...
	// J'ai viré ça pour éviter qu'un clic malencontrueux ferme la fenêtre de saisie
   // $("TB_overlay").onclick = TB_remove;
    ...
    if (baseURL.match(imageURL)) {
        ...
        imgPreloader.onload = function(){
            ...
            $("TB_window").innerHTML += "<a href='' id='TB_ImageOff' title='Close'><img id='TB_Image' src='" + url + "' width='" + imageWidth + "' height='" + imageHeight + "' alt='" + caption + "'/></a>" + "<div id='TB_caption'>" + caption + "<div id='TB_secondLine'>" + imageCount + prev.html + next.html + "</div></div><div id='TB_closeWindow'><a href='#' id='TB_closeWindowButton' title='Close'>fermer</a></div>";
