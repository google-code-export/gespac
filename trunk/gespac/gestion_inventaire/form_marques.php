...
<?PHP
							...
							<div id="combo_type">
								<div id="listbox_type" style='display:inline;'>
									<select name=select_type id=select_type>
										...
										<?PHP
											$liste_des_types = $db_gespac->queryAll ( "SELECT DISTINCT marque_type FROM marques ORDER BY marque_type" );
							...
							<div id="combo_stype">
								<div id="listbox_stype" style='display:inline;'>
									<select name=select_stype id=select_stype>
										<option value=''> >>> Selectionnez une valeur <<< </option>
										<?PHP
											$liste_des_stypes = $db_gespac->queryAll ( "SELECT DISTINCT marque_stype FROM marques ORDER BY marque_stype" );
							...
							<div id="combo_marque">
								<div id="listbox_marque" style='display:inline;'>
									<select name=select_marque id=select_marque>
										<option value=''> >>> Selectionnez une valeur <<< </option>
										<?PHP
											$liste_des_marques = $db_gespac->queryAll ( "SELECT DISTINCT marque_marque FROM marques ORDER BY marque_marque" );
							...
							<div id="combo_modele">
								<div id="listbox_modele" style='display:inline;'>
									<select name=select_modele id=select_modele>
										<option value=''> >>> Selectionnez une valeur <<< </option>
										<?PHP	
											$liste_des_modeles = $db_gespac->queryAll ( "SELECT DISTINCT marque_model FROM marques ORDER BY marque_model" );
	...
	// *********************************************************************************
		...
		$marque_a_modifier = $db_gespac->queryAll ( "SELECT marque_id, marque_type, marque_stype, marque_marque, marque_model FROM marques WHERE marque_id=$id" );

		// valeur à affecter aux champs
		$marque_id 		= $marque_a_modifier[0][0];
		$marque_type 	= $marque_a_modifier[0][1];
		$marque_stype 	= $marque_a_modifier[0][2];
		$marque_marque 	= $marque_a_modifier[0][3];
		$marque_modele	= $marque_a_modifier[0][4];
						...
						<TD>
							<div id="combo_type">
								<div id="listbox_type" style='display:inline;'>
									<select name=select_type id=select_type>
										<?PHP
											$liste_des_types = $db_gespac->queryAll ( "SELECT DISTINCT marque_type FROM marques" );
											foreach ( $liste_des_types as $record ) {	// on remplit la liste des types
												$type = $record[0];
						...
						<TD>
							<div id="combo_stype">
								<div id="listbox_stype" style='display:inline;'>
									<select name=select_stype id=select_stype>
										<?PHP
											$liste_des_stypes = $db_gespac->queryAll ( "SELECT DISTINCT marque_stype FROM marques" );
											foreach ( $liste_des_stypes as $record ) {	// on remplit la liste des types
												$stype = $record[0];
						...
						<TD>
							<div id="combo_marque">
								<div id="listbox_marque" style='display:inline;'>
									<select name=select_marque id=select_marque>
										<?PHP
											$liste_des_marques = $db_gespac->queryAll ( "SELECT DISTINCT marque_marque FROM marques" );
											foreach ( $liste_des_marques as $record ) {	// on remplit la liste des types
												$marque = $record[0];
						...
						<TD>
							<div id="combo_modele">
								<div id="listbox_modele" style='display:inline;'>
									<select name=select_modele id=select_modele>
										<?PHP
											$liste_des_modeles = $db_gespac->queryAll ( "SELECT DISTINCT marque_model FROM marques" );
											foreach ( $liste_des_modeles as $record ) {	// on remplit la liste des types
												$modele = $record[0];
