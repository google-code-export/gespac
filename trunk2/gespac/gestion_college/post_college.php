<?PHP
	...
	*/
	...
	if ( $action == 'creat' ) {
		...
		echo "Création du collège <b>$clg_nom</b> !";
		...
		echo "<br>Mise à jour du mail du compte ATI !";
		...
		echo "<br>Création de la salle <b>Stock</b> !";
		...
		echo "<br>Création de la salle <b>D3E</b> !";
		...
		echo "<br>Création de la salle <b>PRETS</b> !";
	...
	if ( $action == 'mod' ) {
		...
		echo "Modification du collège <b>$clg_nom</b>";
