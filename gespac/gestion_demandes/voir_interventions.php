		...
		<?PHP	
			...
			foreach ( $liste_des_interventions as $record ) {
				...
				echo "<tr class=$tr_class>";
					...
					echo "<td width=20 align=center> <a href='#' onclick=\"OuvrirPage('gestion_demandes/form_interventions.php?id=$interv_id');\" style='display:$hidemodif;'>	<img src='img/write.png' title='gérer l`intervention'>	</a> </td>";
