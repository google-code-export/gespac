<?PHP
	...
	/***********************************************************
	*
	*	REMPLISSAGE DU DIV "historique" de form_demandes.php
	*	avec toutes les demandes faites sur un pc particulier
	*
	************************************************************/
...
?>
	...
	var tableau = "<center><br><br>HISTORIQUE DES DEMANDES POUR CE MATERIEL<br><br><table width=700 align=center BORDER=0 CELLSPACING=0 style='border: 0px solid #ccc;padding: 4px;text-align:center;border-collapse:collapse;'>";
	...
	tableau += "<th>Dossier</th><th>Date</th><th>Etat</th><th>Demandeur</th><th>Texte</th>";
	
	tableau += "<tr style='font-size: small;'>"; 
